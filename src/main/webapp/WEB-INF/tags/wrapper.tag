...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="./resourcess/css/show_img.css" rel="stylesheet"
		type="text/css">
		<script type="text/javascript"
			src="./resourcess/js/jquery-1.7.2.min.js"></script>

		<script type="text/javascript"
			src="./resourcess/js/ckeditor/ckeditor.js"></script>

		<script src="./resourcess/js/Common.js" type="text/javascript"></script>
		<script src="./resourcess/js/PagingContent.js" type="text/javascript"></script>
		<link rel="shortcut icon" type="image/png"
			href="http://icsse2017.hcmute.edu.vn/resourcess/Imagephoto/logo.png">
			<link href="./resourcess/css/lightbox.css" rel="stylesheet"
				type="text/css">
				<script src="./resourcess/js/lightbox.min.js" type="text/javascript"></script>
				<link href="./resourcess/css/search_Article.css" rel="stylesheet">
					


			
						
							<link href="./resourcess/css/WebResource(2).axd" type="text/css"
								rel="stylesheet" class="Telerik_stylesheet">
								
									<link href="./resourcess/css/WebResource(4).axd" type="text/css"
										rel="stylesheet" class="Telerik_stylesheet">
</head>
<!-- <body class="body" onload="popunder();"> -->
		...
		<link href="./resourcess/css/main.css" rel="stylesheet">
			<link href="./resourcess/css/mainPortlets.css" rel="stylesheet">
												...
												<div id="pnTopDisplay" style="width: 1000px; float: left">
														...
														<div>
															<div class="P_top">
																<div class="P_logo">
																	<div class="anh_logo">
																		<img alt=""
																			src="./resourcess/img/Banner Hoi nghi quoc te sua.jpg"
													...
													<div
														...
														<div>
															...
															<link href="./resourcess/css/nivo-slider.css"
																rel="stylesheet">
																<link href="./resourcess/css/default.css"
																	rel="stylesheet">

																	<script src="./resourcess/js/jquery.nivo.slider.js"></script>
																	...
																	<div class="container" style="height: 350px;">
																		<div class="slider-wrapper theme-default">
																			<div id="slider" class="nivoSlider"
																				...
																				<a
																					href="http://icsse2017.hcmute.edu.vn/ArticleId/be204435-0615-4fc3-aa86-392d871decc8/"
																					target="_blank" class="nivo-imageLink"
																					style="display: block;"> <img
																					src="./resourcess/img/HNQT3.jpg" title=""
																				...
																				<a
																					...
																					target="_blank" class="nivo-imageLink"
																					style="display: block;"> <img
																					src="./resourcess/img/HNQT2.jpg" title=""
																					style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
																				...
																				<a
																					...
																					src="./resourcess/img/HNQT1.jpg" title=""
																					style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
        ...
        $('.nivoSlider img').css('height', '350px');
														...
														<div
															...
															<div>
																...
																<link href="./resourcess/css/Menu.Green.css"
																	...
																	<div
																		...
																		<ul class="rmRootGroup rmHorizontal">
																			...
																			<li class="rmItem "><a
																				href="http://icsse2017.hcmute.edu.vn/ArticleId/be204435-0615-4fc3-aa86-392d871decc8/Portlets/MenuRad/#"
																			...
																			<li class="rmItem "><a
																				href="/tagicsse"
																				class="rmLink rmRootLink"><span class="rmText">TAG ICSSE</span></a></li>
														...
														<div class="thongbao_phong">
															<div class="topictb_phong_blue">
																...
																<a class="wobble-horizontal"
																	...
																	<img src="./resourcess/img/arrow_all_phong.png">
																</a>
															</div>
												...
												<div id="ctl06_portlet_9d945843-6c22-4daf-9b88-835da3891673"
													...
													<div>
														...
														<span style="font-size: 16px; color: #002060;">
															<div style="text-align: center;">
																<strong style="text-align: left;">March 30,
																	2017</strong>
															</div>
															<div style="text-align: center;">
														...
														<span
															...
															style="font-weight: bold; color: #002060; font-family: &amp; quot; times new roman&amp;quot; , serif; font-size: 14px; letter-spacing: 1.13333px;"><strong><br>
																...
																<div
																	...
																	<span
																		style="font-size: 10.5pt; letter-spacing: 0.85pt;"><a
																		href="http://icsse2017.hcmute.edu.vn/resourcess/Docs/SubDomain/icsse2017/SS_cfp_Huang.pdf">CALL
																			FOR PAPERS</a></span>
																</div> <br>
																	<div style="text-align: center;">
																		<strong
																				...
																				style="margin: 0px; padding: 0px;"><span
																					style="margin: 0px; padding: 0px; font-size: 14px; background-color: #ffff00; color: #002060;"><strong
																						style="font-family: &amp; quot; times new roman&amp;quot; , serif; font-size: 14px; letter-spacing: 0.85pt; text-align: -webkit-center; background-color: #ffff00;"><span
																							style="color: #002060;"><strong
																								style="letter-spacing: 1.13333px;"><strong>SPECIAL
																										SESSION&nbsp;</strong></strong></span></strong>02<br> FUZZY SYSTEMS &amp;
																							ITS APPLICATIONS</span></strong></span></strong>
																	</div> <strong
																	style="margin: 0px; padding: 0px; font-size: 14px;">
																		<div style="text-align: center;">
																			<strong
																				style="letter-spacing: 0.85pt; margin: 0px; padding: 0px;"><a
																				href="http://icsse2017.hcmute.edu.vn/resourcess/Docs/SubDomain/icsse2017/SS02%20-%20call4pp.pdf"
													...
													<div>
														...
														<br> <span style="color: #002060;"><span
																style="font-size: 14px;"><a
																	...
																	target="_blank"><strong>EASYCHAIR
																			SUBMISSION SITE</strong></a></span><br> <span
																	style="font-size: 14px;"><a
																		href="http://icsse2017.hcmute.edu.vn/resourcess/Docs/SubDomain/icsse2017/ieeeconf_letter.doc"><br>
																				<strong> PAPER FORMAT TEMPLATE DOWNLOAD</strong></a>&nbsp;<br></span></span><span
															style="font-size: 14px;"><br> <strong><strong
																		style="font-size: 14px;"></strong><strong
																		style="font-size: 14px;"></strong><a
																		href="http://icsse2017.hcmute.edu.vn/resourcess/Docs/SubDomain/icsse2017/Instruction%20easychair_ICSSE2017.docx"><strong
									...
									<div id="pageFooter">
										<td colspan="2"><div id="pnBottom">
												<div id="pnBottomDisplay"
													style="clear: both; background: url(/resourcess/img/bgfooter_phong.png) repeat-x; width: 1000px; height: 110px;">
													<div
														...
														<div>
															...
															<div class="truycap_ute">
																<p>
																	Visit month: <span
																		id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,351</span>
																</p>
																<p class="line_footer"></p>
																<p>
																	Visit total:<span
																		id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">6,829</span>
																</p>
															</div>
